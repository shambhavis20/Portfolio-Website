...
import { ArrowRight, MapPin, Microscope, Briefcase, Users } from "lucide-react";
        ...
        <div className="flex justify-center mt-8">
          <Tabs defaultValue="all" className="w-full max-w-md">
            <TabsList className="grid grid-cols-3 w-full">
              ...
              <TabsTrigger value="leadership" onClick={() => setActiveTab("internship")}>Internship</TabsTrigger>
