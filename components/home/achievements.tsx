...
const achievements: Achievement[] = [
  {
    ...
    title: "Second runner up in Mozohack Hackathon by SRM (More than 500 participants) where we built a pose detection and matching application used for photography and modelling",
