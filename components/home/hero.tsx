        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
          ...
          >
            <div className="space-y-2">
              ...
              >
                A passionate software developer with expertise in building & improving performance of web applications, 
                and integrating ML engineering workflows. Currently a software engineer at Microsoft IDC.
              </motion.p>
            </div>
