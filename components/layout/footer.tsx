      ...
      >
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold">Shambhavi Singh</h3>
            <p className="text-sm text-muted-foreground max-w-xs">
              Software Engineer at Microsoft IDC based in Hyderabad,
              specialized in building & improving performance of modern web applications and integrating ML engineering workflows.
            </p>
          </div>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center text-sm text-muted-foreground">
              ...
              <span>{new Date().getFullYear()} Shambhavi Singh. All rights reserved.</span>
            </div>
            <div className="text-sm text-muted-foreground flex items-center gap-1.5">
              <span>Built with</span>
              <Heart className="h-3.5 w-3.5 fill-primary text-primary" />
              <span>using Next.js & Tailwind and Design inspired by <a href="https://github.com/achyut21" target="_blank" rel="noopener noreferrer">Achyut Katiyar</a></span>
            </div>                        
          </div>
        </motion.div>
      </motion.div>
